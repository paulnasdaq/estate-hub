...
def test_search_units_under_a_property(client: TestClient) -> None:
    ...
    client.post(f"{PROPERTIES}/{property_id}/units", json={"name": "Penthouse"})
    client.post(f"{PROPERTIES}/{property_id}/units", json={"name": "Basement"})
...
def test_search_flat_units_list(client: TestClient) -> None:
    property_id = _create_property(client)
    client.post(f"{PROPERTIES}/{property_id}/units", json={"name": "Studio A"})
    client.post(f"{PROPERTIES}/{property_id}/units", json={"name": "Loft B"})
