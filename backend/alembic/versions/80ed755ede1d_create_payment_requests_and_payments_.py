...
def upgrade() -> None:
    ...
    sa.Column('status', sa.Enum('pending', 'failed', 'successful', name='paymentstatus', native_enum=False), nullable=False),
    ...
    with op.batch_alter_table('payment_requests', schema=None) as batch_op:
        batch_op.create_index(batch_op.f('ix_payment_requests_bill_id'), ['bill_id'], unique=False)
    ...
    with op.batch_alter_table('payments', schema=None) as batch_op:
        batch_op.create_index(batch_op.f('ix_payments_payment_request_id'), ['payment_request_id'], unique=False)
